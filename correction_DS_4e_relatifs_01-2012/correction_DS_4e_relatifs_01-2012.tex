...
\begin{center}
\fbox{Correction contrôle 3 (sujet 1)}
\end{center}
...
\begin{enumerate}
  ...
  \item [4.] Le produit de la différence de (-7) et 2 par (-4).
\end{enumerate}
\end{minipage}
\end{tabular}
...
\begin{enumerate}
  ...
  \item b est un nombre négatif. 
   $(-2) \times b$ est le produit de deux nombres
  négatifs donc $(-2) \times b$ est positif.
  
  $b^2=b \times b$ est le produit de deux nombres
  négatifs donc $b^2=b \times b$ est positif.  
...
\ul{Exercice 7}: \qquad 
$5+5- 5\div 5=5+5-1=9$ \qquad \qquad $5-5-5-5=0-5-5=-5-5=-10$
...
\begin{center}
\fbox{Correction contrôle 3 (sujet 2)}
\end{center}
...
\begin{enumerate}
  ...
  \item [4.] Le produit de la différence de (-8) et 3 par (-2).
\end{enumerate}
\end{minipage}
\end{tabular}
...
\ul{Exercice 7}: \qquad 
$5 \times 5- 5\div 5=25-1=24$ \qquad \qquad $5-5+5-5=0+5-5=0$
