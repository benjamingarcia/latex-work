...
\textit{Devoir à rendre sur feuille grand format pour le \ul{jeudi 12 décembre
2013 }.}
...
Recopier et effectuer les calculs suivants en soulignant en vert à chaque étape
le calcul en cours.

\enskip

\textit{Remarque: un résultat donné directement sans les étapes de calculs ne
...
\begin{enumerate}
  ...
  est négative. 
  \item Trouver deux nombres relatifs dont le produit est négatif et la somme
  est positive.
...
Pour chaque question, vous justifierez votre réponse en effectuant les
calculs (produit et somme des deux nombres trouvés).
...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item [a)]Le produit de la somme de -3 et de -5 par la différence de 6 et de
    -8.
    \item [b)]Le quotient de -75 par la différence de 8 et de 14.
   
\end{enumerate}
\item Traduire les expressions mathématiques par des phrases:
...
\ul{Exercice 4:} \textit{(2 points)}
 ...
 Avec les nombres proposés, retrouver le résultat annoncé en respectant
 les consignes suivantes:

$\bullet$ Chaque nombre est utilisé une fois.

$\bullet$ Tous les nombres sont utilisés.

$\bullet$ Toutes les opérations sont autorisées.
...
Recopier et ajouter si nécessaire des parenthèses pour que ces égalités soient
vraies.
